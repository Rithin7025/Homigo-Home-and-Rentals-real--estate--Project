        ...
        <div className='w-full h-[500px]'>
         {
          message.map((mesg)=> (
            <div ref={scrollRef}>
              ...
              <Message message={mesg} isOwn={mesg.sender === currentUser._id }/>
            </div>
