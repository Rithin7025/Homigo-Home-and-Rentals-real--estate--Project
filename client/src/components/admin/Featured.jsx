  ...
  return (
    <div className='w-5/12 bg-gray-100 gap-2 shadow-xl'>
        <div className="flex justify-between p-2">
            <h1 className='font-semibold text-lg p-2 text-slate-600'>Top Revenue</h1>
...
/>
            ...
            <p className='text-center text-gray-500 '>previous transactions in processing 
            ...
            <div className='flex w-full justify-between px-6 py-4 '>
                <div className='flex flex-col items-center'>
                    ...
                    <p className='text-green-900'>$ 450</p>
                    
                </div>
                <div className='flex flex-col items-center'>
                    <p className='font-semibold text-slate-700'>Last week</p>
                    <p className='text-red-900'>$ 450</p>
