  ...
  const [contact,setContact] = useState(false)
    ...
    const options = {
        ...
        handler: async function (response) {
            ...
            console.log(result,'here is the result from front end')
            navigate('/token')
            setBooked(true)
        },
        prefill: {
...
<div className='sm:flex-row md:flex justify-between'>
          ...
          <div className='flex flex-col md:w-1/2 sm:w-full md:ml-8 p-3 mt-7 gap-4'>
           ...
           <Popover className='max-w-xs' content="Book with 2% down payment!! Secure property for 3 months.">
                          <button disabled={currentUser &&  currentUser._id === listing.userRef || listing.isBooked || booked}  onClick={displayRazorpay} type="button" className="disabled:opacity-80 text-white  bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center me-2 dark:bg-blue-600 dark:hover:bg-blue-700 md:w-[200px] dark:focus:ring-blue-800">
          ...
          <path d="M15 12a1 1 0 0 0 .962-.726l2-7A1 1 0 0 0 17 3H3.77L3.175.745A1 1 0 0 0 2.208 0H1a1 1 0 0 0 0 2h.438l.6 2.255v.019l2 7 .746 2.986A3 3 0 1 0 9 17a2.966 2.966 0 0 0-.184-1h2.368c-.118.32-.18.659-.184 1a3 3 0 1 0 3-3H6.78l-.5-2H15Z"/>
                ...
                {currentUser && currentUser._id  === listing.userRef  ? 'your listing' : listing.isBooked ? 'Booked' : 'Book a token'}
           </button>
            </Popover>  
