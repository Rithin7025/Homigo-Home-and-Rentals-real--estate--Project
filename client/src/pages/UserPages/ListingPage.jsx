...
<div className='sm:flex-row md:flex justify-between'>
          ...
          <div className='flex flex-col md:w-1/2 sm:w-full md:ml-8 p-3 mt-7 gap-4'>
           ...
           <Popover className='max-w-xs' content="Book with 2% down payment!! Secure property for 3 months.">
                          <button disabled={currentUser &&  currentUser._id === listing.userRef || listing.isBooked} onClick={displayRazorpay} type="button" className="disabled:opacity-80 text-white  bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center me-2 dark:bg-blue-600 dark:hover:bg-blue-700 md:w-[200px] dark:focus:ring-blue-800">
