...
<div className='sm:flex-row md:flex justify-between'>
          ...
          <button className='p-3 bg-green-900 text-white uppercase rounded-lg font-semibold items-center flex justify-center'><span className='mr-3'>Chat with owner </span> <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
